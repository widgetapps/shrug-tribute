                                ...
                                <div className="flex flex-shrink-0 items-center">
                                    <div className="space-x-3 justify-center items-center text-center">
                                        <Link href="https://www.instagram.com/shrugoffreality/" passHref>
                                            <button
                                                type="button"
                                                className="bg-shrug-red mb-2 inline-block rounded-full p-3 text-xs font-medium uppercase leading-normal text-white shadow-md transition duration-150 ease-in-out hover:bg-white hover:text-shrug-red hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg"
                                            >
                                                <svg
